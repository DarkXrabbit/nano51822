...
===============================================================================
 ...
 Description : ADC via BLE
===============================================================================
 	 	 	 	 	 	 	 	 History
 ---------+---------+--------------------------------------------+-------------
 DATE     |	VERSION |	DESCRIPTIONS							 |	By
 ---------+---------+--------------------------------------------+-------------
 2015/6/22 v1.0.0	First Edition.									LEO
 ===============================================================================
 */
...
//	ble.m_advertising.add_uuid_to_complete_list(nus);		// add bat object to the uuid list of advertising
	...
	uint16_t value;
	Console	 console(nus);	// console use the nus stream.
    ...
    while(1) {
    	...
    	//
    	if ( nus.isAvailable() ) {
    		if ( tmADC.isExpired(1000) ) {
    			tmADC.reset();
    			if ( CAdc::read(AD0, value) ) {
    				console.printf("AD0=%d\n", value);
    				led1.toggle();
    			}
    		}
    	} else led1 = LED_OFF;
